...
function Filter(props)
{
    ...
    return(
        ...
        <div className="w-11/12 flex flex-wrap max-w-max space-x-4 mx-auto gap-y-4 py-4 justify-center">
            ...
            // when we click any botton category is set as we clicked and category is updated as useState hook
            // so when useState is updated ui is rerendered hence Cards will be called and it will show which category cards we want
}
