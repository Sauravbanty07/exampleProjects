...
const SignupForm = ({setIsLoggedIn}) => {
  ...
  return (
    <div>
        ...
        <div className="flex bg-richblack-800 p-1 gap-x-1 rounded-full max-w-max mt-3 mb-3">
        ...
        <form onSubmit={submitHandler} >
            {/* conatain first name and lastname */}
            ...
            {/* here email adress field was done */}
            <label htmlFor="" className="w-full">
                <p className="text-[0.875rem] text-richblack-5 mb-1 leading-[1.375rem]">
            ...
            {/* createpassword and cofirmPassword field */}
            <div className="flex gap-x-4">
